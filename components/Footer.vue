<template>
  <footer>
    <div class="footer-app text-center text-md-start">
      <div class="container">
        <div
          class="
            align-items-center
          ...
          "
        >
          <h3 class="me-md-5 mb-0 text-uppercase">
            Будьте в курсі вигідних пропозицій!
          </h3>
          <div class="subscribe-form">
            <form class="d-block d-sm-flex" action="">
              <input
    ...
    <div class="container-fluid py-5">
      <div class="row">
        ...
        <div class="col-lg-2 col-md-2 offset-lg-1 offset-md-1">
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-lg-10 col-md-10">
            <div class="copyright">
              <p class="mb-0 text-md-left mt-3 mt-md-0">
